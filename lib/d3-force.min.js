/*!
 * Vendored d3-force v3.0.0 and its three dependencies (d3-timer, d3-dispatch,
 * d3-quadtree), concatenated in dependency order. Each part is the upstream
 * UMD build verbatim; they attach themselves to the global "d3" object, which
 * is how d3-force finds its dependencies when loaded without a bundler.
 *
 * ISC licensed, Copyright Mike Bostock.
 */
